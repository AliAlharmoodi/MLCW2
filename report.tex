...
\begin{table}[H]
\centering
\caption{Paper expectation and reproduced accuracy difference (\%).}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lrrrr}
\toprule
Method & Paper & 20 & 50 & 1000 \\
\midrule
No AL & Baseline & 0.00 & 0.00 & 0.00 \\
Margin & Weak early & 2.44 & -3.45 & 1.39 \\
TPC$_{DC}$ & Strong early gain & -1.75 & 0.84 & 3.16 \\
\bottomrule
\end{tabular}}
\end{table}
