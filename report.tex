...
\begin{table}[H]
\centering
\caption{Summary of paper and reproduced trends.}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lll}
\toprule
Method & Paper trend & Our result \\
\midrule
No AL & Baseline reference & Baseline reference \\
Margin & Weak early & Mixed; strongest at 20 labels \\
TPC$_{DC}$ & Strong early gain & Mixed; strongest at 1000 labels \\
\bottomrule
\end{tabular}}
\end{table}
