...
\noindent\textbf{Code repository:} \href{https://github.com/AliAlharmoodi/MLCW2}{https://github.com/AliAlharmoodi/MLCW2}. The accompanying notebook \texttt{Task1\_TPCRP\_CIFAR10.ipynb} contains both the original and modified algorithm implementations for the appendix/code printout requirement.
